...
exports.sendEmail = (req, receiver, token,  type) =>{
    ...
    const mailOptionsConfirmation = {
        ...
        subject: "Your account of the tournament", // Subject line
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 500px;border-bottom: 1px solid #e4e4e4 ;">
                        <tbody>
                          <tr>
                            ...
                            <td bgcolor="#ffffff" align="right" valign="middle" style="padding: 0px; color: #111111; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 48px; font-weight: 400; line-height: 48px;padding:0 0 15px 0;"><a href="https://app.avocode.com/login/" target="_blank" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;color: #797979;font-size: 12px;font-weight:400;-webkit-font-smoothing:antialiased;text-decoration: none;">Login our website</a></td>
                          </tr>
                        </tbody>
                        ...
                        <tbody>
                          <tr>
                            <td bgcolor="#ffffff" align="left" style="padding: 20px 0 0 0; color: #666666; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400;-webkit-font-smoothing:antialiased;">
                                                <p class="headingMobile" style="margin: 0;color: #171717;font-size: 26px;font-weight: 200;line-height: 130%;margin-bottom:5px;">Send you an account for the tournament</p>
                            </td>
                          </tr>
                                            <tr>
                                              <td height="20"></td>
                          ...
                          <tr>
                            <td bgcolor="#ffffff" align="left" style="padding:0; color: #666666; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400;-webkit-font-smoothing:antialiased;">
                                                <p style="margin:0;color:#585858;font-size:14px;font-weight:400;line-height:170%;">Thank you for registering the tournament.</p>
                                                <p style="margin:0;margin-top:20px;line-height:0;"></p>
                                                <p style="margin:0;color:#585858;font-size:14px;font-weight:400;line-height:170%;">Your account: ${token.email} </p>
                                                <p style="margin:0;color:#585858;font-size:14px;font-weight:400;line-height:170%;">Your password: ${token.passNewAth} </p>
                                                <p style="margin:0;color:#585858;font-size:14px;font-weight:400;line-height:170%;">If you have any questions, Please contact us via our email without hesitation. </p>
                            </td>
                          </tr>
                                            <tr>
                                              <td align="center">
                                                  ...
                                                  <tr>
                                                    <td align="center" style="padding: 33px 0 33px 0;">
                                                      <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                        <tr>
                                                          <td align="center" style="border-radius: 4px;" bgcolor="#00bc87"><a href="https://avocode.com/" style="text-transform:uppercase;background:#00bc87;font-size: 13px; font-weight: 700; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none !important; padding: 20px 25px; border-radius: 4px; border: 1px solid #00bc87; display: block;-webkit-font-smoothing:antialiased;" target="_blank"><span style="color: #ffffff;text-decoration: none;">Go to website</span></a></td>
                                                        </tr>
                                                      </table>
                                                    </td>
                                                  </tr>
...
<![endif]-->
    ...
    transporter.sendMail(type === 'SendAccount' ? mailOptionsConfirmation : mailOptionsRecovery, (error, data) => {
        if(error){
            console.log({
                msg: 'error',
                error
